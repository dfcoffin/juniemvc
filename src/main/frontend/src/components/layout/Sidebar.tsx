    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col gap-2">
          ...
          <NavItem to="/beers" icon={<Beer className="h-5 w-5" />} label="Beers" />
          <NavItem to="/customers" icon={<Users className="h-5 w-5" />} label="Customers" />
          <NavItem to="/orders" icon={<ShoppingCart className="h-5 w-5" />} label="Orders" />
